...
<form action="/users/edit" method="post" class="col-xs-offset-4 col-xs-4">
    <div class="form-group">
        ...
        <input type="attribute" class="form-control" name="name" value="${user.name}" id="user-name">
    </div>
    <div class="form-group">
        <label for="email">E-mail</label>
        <input type="email" class="form-control" name="email" value="${user.email}" id="email">
    </div>
    <input type="hidden" class="form-control" name="websiteId" value="${user.websiteId}">
